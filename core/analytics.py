...
class AnalyticsEngine:
    ...
    def get_financial_metrics():
        ...
        # Expense analysis by category - handle case where category field might not exist
        expense_by_category = []
        try:
            # Check if category field exists by trying a simple query
            ...
            # If category field doesn't exist in database, return empty list
            expense_by_category = []
        ...
        try:
            ...
            # If there's an error with the date query, return empty list
            monthly_expenses = []
