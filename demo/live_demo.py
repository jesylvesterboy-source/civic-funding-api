...
def live_demo_showcase():
    ...
    for i, initiative in enumerate(initiatives, 1):
        # FIX APPLIED: Using single quotes for keys
        print(f'{i}. {initiative["status"]} {initiative["name"]}')
        # Make sure the print statement formatting is correct too.
        print(f'    Budget:  | Region: {initiative["region"]} | Impact: {initiative["impact"]}/100')
        print()
...
if __name__ == '__main__':
    ...
    print()
    print('=' * 60)
    # FIX APPLIED: Using single quotes for key
    print(f'DEMO READY: {result["platform"]}')
    print('=' * 60)
